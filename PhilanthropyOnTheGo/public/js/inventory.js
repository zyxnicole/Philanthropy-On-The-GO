...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ "./node_modules/@firebase/analytics/node_modules/tslib/tslib.es6.js");
...
instanceFactory:function(b){b=b.getProvider("auth").getImmediate();return{getUid:q(b.getUid,b),getToken:q(b.nc,b),addAuthTokenListener:q(b.cc,b),removeAuthTokenListener:q(b.Pc,b)}},multipleInstances:!1,instantiationMode:"LAZY",type:"PRIVATE"});_firebase_app__WEBPACK_IMPORTED_MODULE_0__.default.registerVersion("@firebase/auth","0.16.4");_firebase_app__WEBPACK_IMPORTED_MODULE_0__.default.INTERNAL.extendNamespace({User:Im})}else throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library.");})();}).apply(typeof __webpack_require__.g !== 'undefined' ? __webpack_require__.g : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {});
...
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/app */ "./node_modules/@firebase/app/dist/index.esm.js");
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @firebase/component */ "./node_modules/@firebase/component/dist/index.esm.js");
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ "./node_modules/@firebase/installations/node_modules/tslib/tslib.es6.js");
...
const googleAuth = function() {
    ...
    return firebase_app__WEBPACK_IMPORTED_MODULE_0__.default.auth()
...
(function iife() {
  ...
  function showHomePage() {
    (0,_services__WEBPACK_IMPORTED_MODULE_0__.performHomePage)()
    .then(res => {
...
function showDetailOnClickTitle() {
  ...
  function showDetail(item) {
    ...
    .catch(err => updatePageStatus(_errMsgs__WEBPACK_IMPORTED_MODULE_2__.errMsgs[err.error] || err.error)
    )
  }
  ...
  function signIn () {
    document.querySelector('#header .sign-in').addEventListener('click', () => {
      (0,_firebase__WEBPACK_IMPORTED_MODULE_3__.googleAuth)()
      .then(user => {
        const uid = user.uid;
        (0,_services__WEBPACK_IMPORTED_MODULE_0__.performLogin)(uid)
        .then(response => {
          (0,_spa__WEBPACK_IMPORTED_MODULE_1__.showContent)(true);
          renderHome(items);
          updatePageStatus('');
        })
        .catch(err => {
          updateLogStatuse(_errMsgs__WEBPACK_IMPORTED_MODULE_2__.errMsgs[err.error]);
        })
      });
  ...
  function submitNewForm() {
    document.querySelector('#new .submit').addEventListener('click', () => {
      ...
      .catch(err => {
        updateNewFormStatuse(_errMsgs__WEBPACK_IMPORTED_MODULE_2__.errMsgs[err.error]);
      })
    })
  }
  ...
  function logOut() {
    document.querySelector('#header .logout').addEventListener('click', () => {
      ...
      firebase_app__WEBPACK_IMPORTED_MODULE_4__.default.auth()
      .signOut()
      .then(() => {
        // Sign-out successful.
